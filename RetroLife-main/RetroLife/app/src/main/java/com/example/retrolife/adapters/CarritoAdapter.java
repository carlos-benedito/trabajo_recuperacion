...
public class CarritoAdapter extends RecyclerView.Adapter<CarritoAdapter.CarritoViewHolder> implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        String nombreProductoAEliminar = carritoAEliminar.getNombre(); // Obtener el nombre del producto a eliminar

        // Eliminar todos los elementos que tengan el mismo nombre
        for (int i = carritosFiltrados.size() - 1; i >= 0; i--) {
            ...
            if (carrito.getNombre().equals(nombreProductoAEliminar)) {
                ...
                notifyItemRemoved(i);
                // Actualizar el precio total al eliminar cada producto
                precioTotal = precioTotal.subtract(carrito.getPrecio());
            }
        }

        // Realizar la llamada para eliminar los elementos en la base de datos u otro almacenamiento
