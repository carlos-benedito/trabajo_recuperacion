...
public class Productor implements Runnable {
                ...
                while ((line = br.readLine()) != null) {
                    if (line.startsWith("#")) {
                        if (paciente != null) {
                            ...
                            System.err.println("Error: Cita médica sin paciente asociado.");
                        }
                    } else {
                        if (paciente != null) {
    ...
    private Paciente crearPaciente(String line) {
        ...
        if (datos.length >= 6 && !line.startsWith("#")) {
            ...
            System.err.println("Error al leer datos del paciente: " + line);
            return null;
        }
    }
    ...
    private Cita crearCita(String line) {
        ...
        if (datos.length >= 5) {
            ...
            System.err.println("Error al leer datos de la cita: " + line);
            return null;
        }
    }
